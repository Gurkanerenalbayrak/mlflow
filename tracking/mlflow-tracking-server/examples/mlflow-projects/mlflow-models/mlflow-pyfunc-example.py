...
from model import SentimentClassifier # model that i just created
...
def main(args):
    ...
    with mlflow.start_run():
        ...
        signature = infer_signature(model_input=test_inputs.toarray(), model_output=model.predict(test_inputs))
